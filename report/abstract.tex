\begin{abstract}
  ...
  Here, multi-agent networks are studied, and how these can be deployed into known areas in order to provide an infrastructure 
  for localization. A novel optimization based distributed coverage control algorithm for deployment of a multi-agent multilateration network is proposed.
