...
\Cref{fig:3_agnt_tw_k_1_0_distr} shows the initialand final configuration of 3 agents when spawned in the Tinyworld environment, 
...
\begin{figure}[H]
  ...
  \caption{Inital and final configuration of 3 agents in the Tinyworld environment with $k_{1} = 0$ (no active dispersion).}
...
\begin{figure}[H]
  ...
  \caption{Inital and final configuration of 3 agents in the Tinyworld environment with $k_{1} = k_{2} = 1$ (active dispersion).}
